...
students = [
    ...
    {"name": "hawa hussein", "program": "I nformation system"},
...
subjects = {
    "Year 1": [“Principles of Programming Languages(CP 111)”,
...
“Introduction to Probability and Statistics(ST 1210)”
    ...
    "Year 2": [“Computer Networking Protocols(CN 211)”,
...
“ICT Research Methods(IS 221)”
    ...
    "Year 3": [“Internet Programming and Applications II(CP 311)”,
...
“Information and Communication Systems Security(IA 321)”
    ...
    "Year 4": [“ICT Project Management(BT 413)”,
